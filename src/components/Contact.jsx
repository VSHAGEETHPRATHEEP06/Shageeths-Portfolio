...
//           className="absolute -top-32 -left-32 w-64 h-64 md:w-96 md:h-96 bg-cyan-500/5 rounded-full blur-xl md:blur-3xl"
//         />
//         <motion.div
//           initial={{ scale: 0.8, opacity: 0 }}
//           whileInView={{ scale: 1, opacity: 0.05 }}
//           transition={{ duration: 1.5, delay: 0.3 }}
//           className="absolute -bottom-48 -right-48 w-64 h-64 md:w-96 md:h-96 bg-cyan-500/5 rounded-full blur-xl md:blur-3xl"
//         />
//       </div>
...
//           className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"
//         >
//           Get in Touch
//         </motion.h1>
...
//                 key={index}
//                 whileHover={{ y: -3 }}
//                 className="group relative p-4 md:p-5 rounded-lg bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 hover:border-cyan-500/30 transition-all"
//               >
//                 <div className="flex items-start gap-3 md:gap-4">
//                   <div className="p-2 md:p-2.5 bg-cyan-500/10 rounded-md text-cyan-400">
...
//                     animate={{ opacity: 1, y: 0 }}
//                     exit={{ opacity: 0, y: 10 }}
//                     className="p-3 text-sm text-green-400 bg-green-900/20 rounded-lg border border-green-800 flex items-center gap-2"
//                   >
...
//                     animate={{ opacity: 1, y: 0 }}
//                     exit={{ opacity: 0, y: 10 }}
//                     className="p-3 text-sm text-red-400 bg-red-900/20 rounded-lg border border-red-800 flex items-center gap-2"
//                   >
